...
<template>
  <div>
    ...
    {{ detailForm.devicePosition }}
</el-descriptions-item>
                    <el-descriptions-item label="设备厂家">
    {{ detailForm.deviceFactory }}
</el-descriptions-item>
                    <el-descriptions-item label="设备型号">
    {{ detailForm.deviceModel }}
</el-descriptions-item>
                    <el-descriptions-item label="并网点">
    {{ detailForm.gcpName }}
</el-descriptions-item>
                    <el-descriptions-item label="安装角度">
    {{ detailForm.installAngle }}
</el-descriptions-item>
                    <el-descriptions-item label="是否主气象仪">
    {{ detailForm.isMaster }}
</el-descriptions-item>
            </el-descriptions>
        </el-drawer>
