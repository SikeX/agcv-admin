  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        >
            ...
            <el-table-column align="left" label="逆变器编号" prop="inverterNo" min-width="120" />

            <el-table-column align="left" label="逆变器名称" prop="name" min-width="120" />

            <el-table-column align="left" label="运行状态" prop="status" min-width="100" />

            <el-table-column align="left" label="是否调节" prop="isParticipateAdjust" min-width="100">
    <template #default="scope">{{ formatBoolean(scope.row.isParticipateAdjust) }}</template>
</el-table-column>
            <el-table-column align="left" label="额定功率(kW)" prop="ratedPower" min-width="120" />

            <el-table-column align="left" label="有功功率" prop="activePower" min-width="100" />

            <el-table-column align="left" label="有功目标(kW)" prop="apTargetValue" min-width="120" />

            <el-table-column align="left" label="无功功率(kVar)" prop="reactivePower" min-width="120" />

            <el-table-column align="left" label="无功目标(kVar)" prop="rpTargetValue" min-width="120" />

            <el-table-column align="left" label="功率因数" prop="powerFactor" min-width="100" />
...
import {
  createAgvcNbqHis,
  deleteAgvcNbqHis,
  deleteAgvcNbqHisByIds,
  updateAgvcNbqHis,
  findAgvcNbqHis,
  getAgvcNbqHisList,
  getAgvcNbqHistory,
  generateAgvcNbqTestData
...
const generateTestData = async () => {
  ElMessageBox.prompt('请输入设备编号', '生成测试数据', {
    ...
    const res = await generateAgvcNbqTestData({ eqid: value, count: 100 })
    if (res.code === 0) {
