...
<template>
  ...
  <el-select v-model="searchInfo.isBenchmarkInverter" clearable placeholder="请选择">
    ...
    <template #default="scope">{{ formatBoolean(scope.row.isBenchmarkInverter) }}</template>
            ...
            <el-table-column align="left" label="有功实际" prop="ygPreal" width="100" />

            <el-table-column align="left" label="无功实际" prop="wgPreal" width="100" />

            <el-table-column align="left" label="有功上限点号" prop="ygPmax" width="130" />

            <el-table-column align="left" label="有功下限点号" prop="ygPMin" width="130" />

            <el-table-column align="left" label="无功上限点号" prop="wgPmax" width="130" />

            <el-table-column align="left" label="无功下限点号" prop="wgPMin" width="130" />

            <el-table-column align="left" label="功率因数点号" prop="pf" width="130" />

            <el-table-column align="left" label="有功命令点号" prop="ygCmd" width="130" />

            <el-table-column align="left" label="有功模式点号" prop="ygMode" width="130" />

            <el-table-column align="left" label="功率梯度点号" prop="ygRate" width="130" />

            <el-table-column align="left" label="固定降额点号" prop="ygFixW" width="130" />

            <el-table-column align="left" label="百分比降额点号" prop="ygFixPercent" width="140" />

            <el-table-column align="left" label="电网电压" prop="wgU" width="110" />

            <el-table-column align="left" label="Q-U曲线点号" prop="quMode" width="130" />
    ...
    {{ detailForm.pf }}
                    ...
                    <el-descriptions-item label="有功调节命令点号">
    {{ detailForm.ygCmd }}
</el-descriptions-item>
