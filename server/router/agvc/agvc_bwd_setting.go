...
func (s *AgvcBwdSettingRouter) InitAgvcBwdSettingRouter(Router *gin.RouterGroup,PublicRouter *gin.RouterGroup) {
    ...
    }
    {
        ...
        agvcBwdSettingRouterWithoutRecord.POST("updateFromRemote", agvcBwdSettingSyncApi.UpdateFromRemote)       // 从远程调度更新配置
        agvcBwdSettingRouterWithoutRecord.POST("syncToDispatch", agvcBwdSettingSyncApi.SyncToDispatch)          // 同步配置到调度
    }
    {
