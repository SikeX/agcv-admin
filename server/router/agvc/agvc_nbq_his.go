...
func (s *AgvcNbqHisRouter) InitAgvcNbqHisRouter(Router *gin.RouterGroup, PublicRouter *gin.RouterGroup) {
    ...
    }
    {
        ...
        agvcNbqHisRouterWithoutRecord.GET("exportAgvcNbqHistory", agvcNbqHisApi.ExportAgvcNbqHistory)                 // 导出逆变器历史数据token
        agvcNbqHisRouterWithoutRecord.GET("exportAgvcNbqHistoryByToken", agvcNbqHisApi.ExportAgvcNbqHistoryByToken) // 通过token导出逆变器历史数据
    }
    {
