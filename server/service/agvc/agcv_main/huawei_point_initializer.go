    ...
    pointMappings := []agvc_main.PointMapping{
        {
            EQType:      "02",
            DataType:    "05",
            Point:       HW_POINT_REACTIVE_GRADIENT,
            PointName:   "无功功率变化梯度",
            Unit:        "%/s",
        ...
        },
        {
            EQType:      "02",
            DataType:    "05",
            Point:       HW_POINT_ACTIVE_GRADIENT,
            PointName:   "有功功率变化梯度",
            Unit:        "%/s",
