...
type AgvcBwdSetting struct {
    ...
    Eqid                          *int     `json:"eqid" form:"eqid" gorm:"column:eqid;"`                                                                               //设备编号
    ...
    Capacity                      *float64 `json:"capacity" form:"capacity" gorm:"column:capacity;"`                                //并网点容量(kW)
    GridConnectionDate            *string  `json:"gridConnectionDate" form:"gridConnectionDate" gorm:"column:grid_connection_date;"` //并网日期
}
